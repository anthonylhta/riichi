...
// Cron Job (see vercel.json) that fires just after the UTC day boundary —
// getOrCreateToday() generates + caches the day's puzzle if the row is missing,
// otherwise it's a cheap no-op read.
//
